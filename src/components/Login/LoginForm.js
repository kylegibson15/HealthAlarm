...
export default class LoginForm extends Component {
  ...
  render() {
    ...
    return (<View style={styles.container}>
      ...
      <TextInput name="username" placeholder="username" placeholderTextColor="white" returnKeyType="next" ref={(input) => this.usernameInput = input} onChangeText={(username) => this.usernameInputValue = username} onSubmitEditing={() => this.passwordInput.focus()} keyboardType="email-address" autoCapitolize={false} style={styles.input}/>
